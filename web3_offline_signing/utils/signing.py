...
def hash_of_signed_transaction(txn_obj):
    ...
    :rtype: `~web3_offline_signing.utils.encoding.ExtendedRLP`
    '''
...
class LocalAccount(object):
    ...
    same API as web3_offline_signing.js: https://web3js.readthedocs.io/en/1.0/web3-eth-accounts.html#create
    '''
    def __init__(self, key, account):
        '''
        :param eth_keys.PrivateKey key: to prefill in private key execution
        :param web3_offline_signing.account.Account account: the key-unaware management API
        '''
