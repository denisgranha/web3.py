...
from web3_offline_signing.iban import Iban

from web3_offline_signing.account import Account
from web3_offline_signing.contract import (
    Contract,
)
...
from web3_offline_signing.utils.blocks import (
    select_method_for_block_identifier,
)
from web3_offline_signing.utils.empty import (
    empty,
)
from web3_offline_signing.utils.encoding import (
    to_hex,
)
...
from web3_offline_signing.utils.transactions import (
...
class Eth(Module):
    ...
    def protocolVersion(self):
        return self.web3_offline_signing.manager.request_blocking("eth_protocolVersion", [])

    @property
    def syncing(self):
        return self.web3_offline_signing.manager.request_blocking("eth_syncing", [])

    @property
    def coinbase(self):
        return self.web3_offline_signing.manager.request_blocking("eth_coinbase", [])

    @property
    def mining(self):
        return self.web3_offline_signing.manager.request_blocking("eth_mining", [])

    @property
    def hashrate(self):
        return self.web3_offline_signing.manager.request_blocking("eth_hashrate", [])

    @property
    def gasPrice(self):
        return self.web3_offline_signing.manager.request_blocking("eth_gasPrice", [])

    @property
    def accounts(self):
        return self.web3_offline_signing.manager.request_blocking("eth_accounts", [])

    @property
    def blockNumber(self):
        return self.web3_offline_signing.manager.request_blocking("eth_blockNumber", [])

    def getBalance(self, account, block_identifier=None):
        if block_identifier is None:
            block_identifier = self.defaultBlock
        return self.web3_offline_signing.manager.request_blocking(
            "eth_getBalance",
    ...
    def filter(self, filter_params):
        if is_string(filter_params):
            if filter_params == "latest":
                filter_id = self.web3_offline_signing.manager.request_blocking(
                    "eth_newBlockFilter", [],
                )
    ...
    def getCompilers(self):
        return self.web3_offline_signing.manager.request_blocking("eth_getCompilers", [])

    def getWork(self):
        return self.web3_offline_signing.manager.request_blocking("eth_getWork", [])
